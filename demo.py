...
class Login:
   ...
   def loginform(self):
      ...
      Frame_login.place(x=0,y=0,height=900,width=1500)
      self.img=ImageTk.PhotoImage(file="C:\\Users\\sumit\\Desktop\\PROJECT\\login.jpg")
      ...
      frame_input.place(x=890,y=130,height=450,width=350)
      ...
      label2=Label(frame_input,text="Email id",font=("Goudy old style",20,"bold"),
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host='localhost',user='rakshith',password='password',
   ...
   def Register(self):
      ...
      frame_input2=Frame(self.root,bg='blue')
      ...
      btn2=Button(frame_input2,command=self.register,text="Register"
                  ...
                  ,cursor="hand2",font=("times new roman",15),fg="black",

                  bg="white",bd=0,width=15,height=1)
